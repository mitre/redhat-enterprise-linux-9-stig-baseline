...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify RHEL 9 does not accept router advertisements on all IPv6 interfaces by default, unless the system is a router.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-257975'
  tag rid: 'SV-257975r1155766_rule'
  tag stig_id: 'RHEL-09-254030'
  tag fix_id: 'F-61640r1155765_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
