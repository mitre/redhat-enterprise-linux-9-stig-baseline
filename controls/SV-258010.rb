control 'SV-258010' do
  ...
  desc 'check', %q(Verify the SSH daemon performs privilege separation with the following command:

$ sudo /usr/sbin/sshd -dd 2>&1 | awk '/filename/ {print $4}' | tr -d '\r' | tr '\n' ' ' | xargs sudo grep -iH '^\s*useprivilegeseparation'
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-61751r952215_chk'
  tag severity: 'medium'
  tag gid: 'V-258010'
  tag rid: 'SV-258010r991589_rule'
