...
'
  desc 'check', %q(Verify that any SSH connection to the operating system displays the Standard Mandatory DOD Notice and Consent Banner before granting access to the system.
...
Banner /etc/issue'
  ...
  tag check_id: 'C-61722r952172_chk'
  tag severity: 'medium'
  tag gid: 'V-257981'
  tag rid: 'SV-257981r958390_rule'
