control 'SV-258031' do
  ...
  desc 'check', "Verify RHEL 9 is configured to ignore the Ctrl-Alt-Del sequence in the GNOME desktop with the following command:
...
$ sudo dconf update)
  impact 0.5
  tag check_id: 'C-61772r1134919_chk'
  tag severity: 'medium'
  tag gid: 'V-258031'
  tag rid: 'SV-258031r1134920_rule'
