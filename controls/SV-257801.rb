control 'SV-257801' do
  title 'RHEL 9 must enable kernel parameters to enforce discretionary access control (DAC) on hardlinks.'
...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify RHEL 9 is configured to enable DAC on hardlinks.
...
If "fs.protected_hardlinks" is not set to "1" or is missing, this is a finding.'
  desc 'fix', 'Configure RHEL 9 to enable DAC on hardlinks.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-257801'
  tag rid: 'SV-257801r1155703_rule'
  tag stig_id: 'RHEL-09-213030'
  tag fix_id: 'F-61466r1155702_fix'
