...
$ sudo dconf update)
  ...
  tag severity: 'medium'
  tag gid: 'V-270174'
  tag rid: 'SV-270174r1044831_rule'
  tag stig_id: 'RHEL-09-171011'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-74108r1044830_fix'
  ...
  # expected_banner = banner_text.strip

  # describe 'The GUI Login Banner' do
  #   it 'matches the Standard Mandatory DOD Notice and Consent Banner exactly' do
