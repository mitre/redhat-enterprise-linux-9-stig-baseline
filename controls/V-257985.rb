...
"
  desc 'check', %q(Verify that RHEL 9 remote access using SSH prevents users from logging on directly as "root" with the following command:
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-61726r952180_chk'
  tag severity: 'medium'
  tag gid: 'V-257985'
  tag rid: 'SV-257985r997069_rule'
